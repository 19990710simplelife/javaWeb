...
public class IUsersDAOImpl implements IUsersDAO {
    ...
    public Users check(Users users) {
        ...
        Users user = sqlSession.selectOne("cn.simplelife.work._03demo.dao.IUsersDAO.check", users);
        sqlSession.commit();
        sqlSession.close();
        return user;
    }
    ...
    public Users checkUsersByUsername(String username) {
        SqlSession sqlSession = MyBatisUtils.openSession();
        Users user = sqlSession.selectOne("cn.simplelife.work._03demo.dao.IUsersDAO.checkUsersByUsername", username);
        sqlSession.commit();
        sqlSession.close();
        return user;
    }
